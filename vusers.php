...
?>
    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            ...
            ?>
            <h5 class="text-muted my-3">Verified Users : <span class="text-danger"><?php echo $vu; ?></span></h5>
            <hr>
        </div>
        <form action="db.php" method="post">
            <div class="row col-sm-12 mb-3">
                ...
                ?>
                <input type="submit" value="REMOVE" name="rvu" class="btn btn-danger">
            </div>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="table-hover">
                        <td><input type="checkbox" name="selectvu[]" value="<?php echo $row['uid']; ?>"></td>
    ...
    <!-- Modal-2 Start, Remove Message -->

    <div class="modal fade" id="myModal2">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title text-white">Verified Users Page says :</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body text-primary">
...
{
    checkboxes=document.getElementsByName('selectvu[]');
