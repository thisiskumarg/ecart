...
?>
    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            ...
            ?>
            <h5 class="text-muted my-3">Suspended Products : <span class="text-danger"><?php echo $sp; ?></span></h5>
            <hr>
        </div>
        <form action="db.php" method="post">
            <div class="row col-sm-12 mb-3">
                ...
                {
                ?>
                <input type="submit" value="VERIFY" name="vsp" class="btn btn-success mx-2">
                <?php 
                }
                elseif($roleid == '2')
                {
                ?>
                <input type="submit" value="UNSUSPEND" name="usp" class="btn btn-warning mx-2">
                <?php 
                }
                ?>
                <input type="submit" value="REMOVE" name="rsp" class="btn btn-danger">
            </div>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="table-hover">
                        <td><input type="checkbox" name="selectsp[]" value="<?php echo $row['pid']; ?>"></td>
                        <td><img src="<?php echo $row['pimage']; ?>" alt="Suspended-Product-Photo" class="img-fluid" style="height: 100px; width: 130px;"></td>
    ...
    <div class="modal fade" id="myModal2">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title text-white">Suspended Products Page says :</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body text-primary">
                    <p>Product is <span class="text-success">verified</span> successfully.</p>
                </div>
            </div>
        </div>
    </div>
...
{
    checkboxes=document.getElementsByName('selectsp[]');
