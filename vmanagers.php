...
?>
    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            ...
            ?>
            <h5 class="text-muted my-3">Verified Vendors : <span class="text-danger"><?php echo $vv; ?></span></h5>
            <hr>
        </div>
        <form action="db.php" method="post">
            <div class="row col-sm-12 mb-3">
                ...
                ?>
                <input type="submit" value="SUSPEND" name="svm" class="btn btn-warning mr-2">
                <input type="submit" value="REMOVE" name="rvm" class="btn btn-danger">
            </div>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="table-hover">
                        <td><input type="checkbox" name="selectvm[]" value="<?php echo $row['uid']; ?>"></td>
    ...
    <div class="modal fade" id="myModal2">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title text-white">Verified Vendors Page says :</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body text-primary">
                    <p>Vendor is <span class="text-warning">suspended</span> successfully.</p>
                </div>
            </div>
        </div>
    </div>
...
{
    checkboxes=document.getElementsByName('selectvm[]');
