...
?>
    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            ...
            if($roleid == '1')
            {
                $sql = "SELECT pid FROM products WHERE is_verified = '0'";
                $res = mysqli_query($con, $sql);
            }
            elseif($roleid == '2')
            {
                $sql = "SELECT pid FROM products WHERE is_verified = '0' AND uid = '$uid'";
                $res = mysqli_query($con, $sql);
            }
            foreach($res as $row)
            {
            ...
            ?>
            <h5 class="text-muted my-3">Non - Verified Products : <span class="text-danger"><?php echo $nvp; ?></span></h5>
            <hr>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="table-hover">
                            ...
                            <td><img src="<?php echo $row['pimage']; ?>" alt="Non-Verified_Product_Photo" class="img-fluid" style="height: 100px; width: 130px;"></td>
    ...
    <div class="modal fade" id="myModal2">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title text-white">Non-Verified Products Page says :</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body text-primary">
...
{
    checkboxes=document.getElementsByName('selectnvp[]');
